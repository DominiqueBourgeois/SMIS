function [trans_p, allowed_n_trans, allowed_trans_indices]=get_allowed_transitions_pct(trans_p, activated, sm_par)
...
%
% INPUTS:
%   activated: the single molecule activation state
