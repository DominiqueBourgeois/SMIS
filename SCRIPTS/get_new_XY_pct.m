function [x_h_d, y_h_d,sm] = get_new_XY_pct(x_h, y_h, sm, D_ras, dt, S, sm_par, im_par)
...
if sm_par.V(c_ds)>0
    [p_h_out,v_h_out,p_h_out_np]=update_directed_motion_2D([x_h,y_h],[sm{v_x_idx}, sm{v_y_idx}], dt, c_ds, n_ds, sm_par,im_par);
