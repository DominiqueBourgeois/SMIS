function     [im_par, lasers]=get_background(im_par, lasers)
...
if im_par.bg.bg_ch1>0
    im_par=get_background_ch_pct(im_par, attenuation_factor, lasers, 1);
end
if im_par.bg.add_textured_bg==1
    ...
    if im_par.bg.textured_bg_ch1>0
        im_par=get_tx_background_ch_pct(im_par, tx_pattern, tx_attenuation_factor, lasers, 1);
    end
end

%Channel 2
if im_par.two_channel==1 && im_par.bg.bg_ch2>0
    im_par=get_background_ch_pct(im_par, attenuation_factor, lasers, 2);
end
if im_par.bg.add_textured_bg==1
    if im_par.two_channel==1 && im_par.bg.textured_bg_ch2>0
        im_par=get_tx_background_ch_pct(im_par, tx_pattern, tx_attenuation_factor, lasers, 2);
    end
end
