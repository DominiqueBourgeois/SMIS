function [state_duration, state_origin, state_occurence]=get_state_info(s,t,state_id,acq_time, merge)
...
%Treat the case of several merge states to obtain global on times (or ofttimes)
state_no_change=nan;
if nargin==5
    if merge==1
        if ~isempty(w)
